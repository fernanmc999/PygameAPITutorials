...
def main():
    ...
    while True:
        for event in pygame.event.get():
            ...
            #pygame.mixer.music.play() #putting the mp3 here will have it as background music
        ...
        caption1=font1.render('Two Dogs', True, BLACK, (255, 255, 0))
        ...
        caption2=font2.render('I am a lovely cat :3', True, WHITE)
